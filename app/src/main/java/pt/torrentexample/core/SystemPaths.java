...
package pt.torrentexample.core;
...
public final class SystemPaths {
    ...
    private static final String APP_STORAGE_PATH = "TorrentExample";
    ...
    private static final String APPLICATION_APK_NAME = "torrent_example.apk";
