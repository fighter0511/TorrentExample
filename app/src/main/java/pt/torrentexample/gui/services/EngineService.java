...
import frostwire.util.ThreadPool;
import pt.torrentexample.R;
import pt.torrentexample.ShowTorrentFile;
...
//        remoteViews.setOnClickPendingIntent(R.id.view_permanent_status_vpn_icon, showVPNIntent);
        ...
        Notification notification = new NotificationCompat.Builder(context).
                setSmallIcon(R.drawable.torrent_icon_flat).
    ...
    public void notifyDownloadFinished(String displayName, File file) {
        try {
            ...
            Intent i = new Intent(context, ShowTorrentFile.class);
