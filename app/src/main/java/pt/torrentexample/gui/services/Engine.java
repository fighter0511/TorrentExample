...
package pt.torrentexample.gui.services;
...
import frostwire.util.BloomFilter;
...
public final class Engine implements IEngineService {
    ...
    public byte getState() {
        return service != null ? service.getState() : STATE_INVALID;
    }
    ...
    private void startEngineService(final Context context) {
        ...
        context.bindService(i, connection = new ServiceConnection() {
            ...
            public void onServiceConnected(ComponentName name, IBinder service) {
                // avoids: java.lang.ClassCastException: android.os.BinderProxy cannot be cast to EngineService$EngineServiceBinder
                if (service instanceof EngineService.EngineServiceBinder) {
