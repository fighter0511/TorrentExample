...
import frostwire.bittorrent.BTDownloadItem;
import frostwire.bittorrent.PaymentOptions;
import frostwire.logging.Logger;
import frostwire.search.WebSearchPerformer;
import frostwire.transfers.TransferItem;
import frostwire.transfers.TransferState;
import pt.torrentexample.R;
import pt.torrentexample.core.ConfigurationManager;
import pt.torrentexample.core.Constants;
import pt.torrentexample.core.MediaType;
import pt.torrentexample.gui.NetworkManager;
import pt.torrentexample.gui.Util.UIUtils;
import pt.torrentexample.gui.adapter.menu.CancelMenuAction;
import pt.torrentexample.gui.adapter.menu.CopyToClipboardMenuAction;
import pt.torrentexample.gui.adapter.menu.PauseDownloadMenuAction;
import pt.torrentexample.gui.adapter.menu.ResumeDownloadMenuAction;
...
//            }
            ...
            boolean openMenu = !errored && download.isComplete() && (tag instanceof HttpDownload );
            if (openMenu) {
