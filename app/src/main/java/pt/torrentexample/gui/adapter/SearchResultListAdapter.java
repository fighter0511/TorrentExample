...
import frostwire.search.StreamableSearchResult;
import frostwire.search.soundcloud.SoundcloudSearchResult;
import frostwire.search.torrent.TorrentSearchResult;
import frostwire.search.youtube.YouTubeCrawledSearchResult;
import frostwire.search.youtube.YouTubeCrawledStreamableSearchResult;
...
import pt.torrentexample.gui.view.MediaPlaybackOverlay;
import pt.torrentexample.gui.view.SearchThumbnailImageView;
    ...
    private int getFileTypeIconId() {
        switch (fileType) {
            ...
            case Constants.FILE_TYPE_TORRENTS:
                return R.drawable.torrent_icon_flat;
            default:
